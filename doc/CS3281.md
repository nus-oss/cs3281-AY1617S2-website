...
CS3281 has two main parts: [External Project](#external-project), [Expertise Area](#expertise-area)
...
* You are expected to make periodic PRs (at least once every 3 weeks) to enhance the relevant chapter(s) as you learn the topic. 
  The PR should be peer reviewed by a team member before it is merged.
...
* Staring looking for an external OSS project. Once you found a few potential projects, try to get started on contributing to them. 
